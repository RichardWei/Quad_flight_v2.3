...
/*=====================================================================================================*/
/*=====================================================================================================*/
extern S_INT16_XYZ 	GYRO_I,L3G4200_GYRO_LAST,GYRO_OFFSET;//角速度和加速度	
#define L3G4200_I2C_ADDR				((u8)0xD2)

#define L3G4200_ID				      ((u8)0x0F)	// 0xD3
...
#define L3G4200_MULTIPLE				((u8)0xA8)	// 硈尿弄

#define L3G4200_s250dps					(0.00875)		// 8.75mdps
#define L3G4200_s500dps					(0.01750)		// 17.5mdps
#define L3G4200_s2000dps				(0.07000)		// 70mdps  数值变化1对应的角速度
/*=====================================================================================================*/
/*=====================================================================================================*/
extern void L3G4200_Init( void );
extern void Read_L3G4200D(S_INT16_XYZ*ptResult);
